        ...
        .directive('ngJsonExportExcel', function () {
            return {
                ...
                link: function (scope, element) {
                    scope.namafile = !!scope.namafile ? scope.namafile : 'export-excel';
                    scope.extfile = !!scope.extfile ? scope.extfile : 'xlsx';
                    var fields = [];
                    var header = [];
                    ...
                    element.bind('click', function () {
                        ...
                        return saveAs(blob, [scope.namafile + '.' + scope.extfile]);
                    });
