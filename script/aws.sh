...
# Default-Stop:      0 1 6
# Description:       awsconfig svc ver 1.0 lwx 20180820
### END INIT INFO
...
USER=adhitya
GROUP=rachman
ROOTDIR=/home/adhitya/projects/website/angular
DAEMON=$ROOTDIR/www/api/env/bin/gunicorn
APPDIR=$ROOTDIR/www/api
SOCKFILE=$ROOTDIR/config/aws.sock
PIDFILE=$ROOTDIR/www/api/log/gunicorn.pid
LOGFILE=$ROOTDIR/www/api/log/gunicorn.log
# Gunicorn
APP_MAIN=app
...
start(){
  ...
  local PRE_EXEC="source $ROOTDIR/www/api/env/bin/activate;cd $APPDIR;"
